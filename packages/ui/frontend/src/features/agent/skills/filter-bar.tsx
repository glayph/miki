    ...
    <div className="border-border/40 bg-muted/20 flex flex-wrap items-center gap-3 rounded-xl border p-2 shadow-sm">
      <div className="relative min-w-[200px] flex-1">
        ...
        <Input
          ...
          aria-label={t("pages.agent.skills.search_placeholder")}
          name="skills_filter_search"
          autoComplete="off"
      ...
      <div className="bg-background/50 ring-border/20 inline-flex items-center rounded-lg p-0.5 shadow-sm ring-1">
        <button
          ...
          title={t("pages.agent.skills.layout_grouped", {
            defaultValue: "Grouped layout",
          })}
          className={cn(
        ...
        <button
          ...
          title={t("pages.agent.skills.layout_grid", {
            defaultValue: "Grid layout",
          })}
          className={cn(
            "rounded-md px-2.5 py-1.5 text-xs font-medium transition-[background-color,color,box-shadow]",
