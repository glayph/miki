...
- **Broader AI scope**: AAAI covers all of AI, not just ML. Papers on planning, reasoning, knowledge representation, NLP, vision, robotics, and cooperative AI systems are all in scope. Reviewers may not be deep ML specialists.
