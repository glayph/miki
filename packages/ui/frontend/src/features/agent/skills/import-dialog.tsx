...
function SkillImportPanel({
  ...
  return (
    <div className="space-y-4">
      <div
        className={cn(
          "flex min-h-48 cursor-pointer flex-col items-center justify-center gap-3 rounded-xl border-2 border-dashed px-4 py-6 text-center transition-[background-color,border-color,color,box-shadow] duration-300",
          isDragActive
