...
```bash
source "${Miki_HOME:-$HOME/.Miki}/skills/github/github-auth/scripts/gh-env.sh"
...
gh pr review $PR_NUMBER --approve --body "Reviewed by Miki. Code looks clean — good test coverage, no security concerns."
