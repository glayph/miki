...
export const PlaywrightPage: React.FC = () => {
  const doc = getDocByPath('/docs/ecosystem/playwright.md');
    ...
    >
      <div className="mb-8">
        <div className="flex items-center gap-2 mb-3">
          <span className="text-[11px] font-mono uppercase tracking-widest px-2.5 py-1 rounded bg-[#111113] border border-[#27272A] text-[#FF5A3C] font-bold">
            ECOSYSTEM / PLAYWRIGHT CHROMIUM TOOL
          </span>
          <span className="text-xs font-mono text-[#A1A1AA]">Headless Stealth Automation</span>
        </div>
        <h1 className="text-3xl sm:text-5xl font-bold tracking-tight text-[#F4F4F5] mb-4">
          Playwright Chromium Automation Tool Spec
        </h1>
        <p className="text-[#A1A1AA] text-base max-w-3xl leading-relaxed">
          Integrated headless browser driver supporting real DOM interaction, compressed markdown extraction, and form interaction for web-bound agent tasks.
        </p>
      </div>
      ...
      {doc ? (
        ...
        <div className="p-8 bg-[#111113] border border-[#27272A] rounded-xl text-xs font-mono text-[#A1A1AA]">
          Document /docs/ecosystem/playwright.md not found.
        </div>
      )}
    </motion.div>
  );
