...
export const Soc2Page: React.FC = () => {
  const doc = getDocByPath('/docs/legal/soc2.md');
    ...
    >
      <div className="mb-8">
        <div className="flex items-center gap-2 mb-3">
          <span className="text-[11px] font-mono uppercase tracking-widest px-2.5 py-1 rounded bg-[#111113] border border-[#27272A] text-[#FF5A3C] font-bold">
            LEGAL / SOC2 TYPE II READINESS
          </span>
          <span className="text-xs font-mono text-[#A1A1AA]">Security & Compliance Report</span>
        </div>
        ...
        <p className="text-[#A1A1AA] text-sm leading-relaxed font-mono">
          Miki cloud runtimes and isolated VPC enterprise agent nodes maintain strict compliance across the AICPA Trust Services Criteria.
        </p>
      </div>
      ...
      {doc ? (
        ...
        <div className="p-8 bg-[#111113] border border-[#27272A] rounded-xl text-xs font-mono text-[#A1A1AA]">
          Document /docs/legal/soc2.md not found.
        </div>
      )}
    </motion.div>
  );
