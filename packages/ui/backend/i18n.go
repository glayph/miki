...
var translations = map[Language]map[TranslationKey]string{
	LanguageEnglish: {
		...
		MenuOpenTooltip:    "Open miki console in browser",
		MenuAbout:          "About",
		MenuAboutTooltip:   "About miki",
		...
		MenuQuit:           "Quit",
		MenuQuitTooltip:    "Exit miki",
		Exiting:            "Exiting miki...",
		DocUrl:             "https://docs.miki.io/docs/",
	},
	LanguageChinese: {
		AppTooltip:         "%s - Web Console",
		MenuOpen:           "打开控制台",
		MenuOpenTooltip:    "在浏览器中打开 miki 控制台",
		MenuAbout:          "关于",
		MenuAboutTooltip:   "关于 miki",
		MenuVersion:        "版本: %s",
		...
		MenuQuit:           "退出",
		MenuQuitTooltip:    "退出 miki",
		Exiting:            "正在退出 miki...",
		DocUrl:             "https://docs.miki.io/zh-Hans/docs/",
	},
}
