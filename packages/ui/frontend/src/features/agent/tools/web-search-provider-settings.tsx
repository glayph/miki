      ...
      <div className="flex items-center justify-between gap-4 p-5">
        ...
        >
          <Switch
            ...
            aria-label={t("pages.agent.tools.web_search.toggle_provider", {
              defaultValue: "Enable {{provider}} web search provider",
        ...
        >
          <div className="ml-8 flex max-w-xl flex-col gap-5">
            ...
            >
              <Input
                type="number"
                name={`web_search_${providerId}_max_results`}
                autoComplete="off"
                min={1}
                max={10}
            ...
            {baseUrlProviders.has(providerId) && (
              ...
              >
                <Input
                  name={`web_search_${providerId}_base_url`}
                  autoComplete="off"
            ...
            {apiKeyProviders.has(providerId) && (
              ...
              >
                <KeyInput
                  name={`web_search_${providerId}_api_key`}
            ...
            {modelProviders.has(providerId) && (
              ...
              >
                <Input
                  name={`web_search_${providerId}_model`}
                  autoComplete="off"
