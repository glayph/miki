    ...
    >
      ...
      <div className="mb-12">
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="text-xs font-mono text-[#A1A1AA]">ReAct Orchestration Loop v1.4.2</span>
        </div>
      ...
      <div className="bg-[#111113] border border-[#27272A] rounded-xl p-6 sm:p-8 mb-16">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8 pb-6 border-b border-[#27272A]">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-3.5 py-1.5 text-xs font-mono font-medium text-white bg-[#111113] border border-[#27272A] hover:bg-[#27272A] rounded-lg transition-all flex items-center gap-1.5"
            >
            ...
            <button
              ...
              disabled={isSimulating}
              className="px-4 py-1.5 text-xs font-mono font-medium text-white bg-[#FF5A3C] hover:bg-[#FF7A5C] rounded-lg transition-all flex items-center gap-1.5 disabled:opacity-50"
            >
            ...
            return (
              <button
                ...
                className={`p-3 rounded-lg border text-left transition-all ${
                  isActive
                    ? 'bg-[#0A0A0B] border-[#FF5A3C] shadow-lg shadow-[#FF5A3C]/10'
                    : isPassed
                    ? 'bg-[#0A0A0B]/60 border-[#27272A] text-[#A1A1AA]'
                    : 'bg-[#0A0A0B]/30 border-[#27272A]/50 text-[#A1A1AA]/50'
                }`}
              >
        ...
        <div className="bg-[#0A0A0B] border border-[#27272A] rounded-xl p-6 grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div>
            <div className="inline-block px-2.5 py-0.5 rounded bg-[#111113] border border-[#FF5A3C]/40 text-[#FF5A3C] font-mono text-[10px] uppercase font-bold mb-3">
            ...
            <div className="p-3 bg-[#111113] border border-[#27272A] rounded-lg text-xs text-[#F4F4F5] font-mono flex items-start gap-2">
          ...
          <div>
            ...
            <div className="bg-[#111113] border border-[#27272A] rounded-lg p-4 font-mono text-xs text-[#A1A1AA] overflow-x-auto">
      ...
      <div className="bg-[#111113] border border-[#27272A] rounded-xl p-6 sm:p-8 mb-16">
        <div className="flex items-center gap-2 mb-2">
          <Calculator className="w-5 h-5 text-[#FF5A3C]" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Controls */}
          <div className="space-y-6 lg:col-span-2 bg-[#0A0A0B] border border-[#27272A] rounded-xl p-6">
            <div>
              ...
              <input
                ...
                className="w-full accent-[#FF5A3C] bg-[#111113] rounded cursor-pointer"
              />
            </div>
                  ...
                  <button
                    ...
                    className={`py-2 px-3 text-xs font-mono rounded-lg border transition-all ${
                      modelType === m.id
                        ...
                        : 'bg-[#111113] text-[#A1A1AA] border-[#27272A] hover:text-white'
                    }`}
                  >
                    {m.label}
                  </button>
          ...
          {/* Results Summary Box */}
          <div className="bg-[#0A0A0B] border border-[#27272A] rounded-xl p-6 flex flex-col justify-between">
            <div>
              ...
              <div className="space-y-3 font-mono text-xs border-t border-[#27272A] pt-4">
            ...
            <button
              ...
              className="w-full mt-6 py-2 px-3 text-xs font-mono text-white bg-[#111113] border border-[#27272A] hover:border-[#FF5A3C] rounded-lg transition-all text-center"
            >
