...
export function MarketSkillCard({
  ...
  return (
    <Card
      className="group border-border/40 bg-card/40 hover:border-border/80 hover:bg-card relative overflow-hidden transition-[background-color,border-color,box-shadow] hover:shadow-md"
      size="sm"
    >
      {result.installed && (
            ...
            {result.url ? (
              <div className="pt-1">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="text-primary/80 hover:text-primary inline-flex max-w-full text-xs break-all transition-colors hover:underline hover:underline-offset-4"
                  title={result.url}
                >
                  {result.url}
                </a>
              ...
              <TooltipTrigger asChild>
                ...
                >
                  <Button
                    ...
                    className="shadow-sm transition-[background-color,color,box-shadow]"
