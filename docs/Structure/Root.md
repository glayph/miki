...
│   ├── miki.js                   Main CLI launcher (resolves runtime, spawns gateway + CLI + memory)
│   └── miki-doctor.mjs           Health diagnostics script
...
├── promlem-lists/                   Open problem tracking (unsolved only)
│   ├── problems/                    Remaining documented bugs/issues
│   └── skill.md                     Issue-resolution process skill
